...
//		bluetooth.write(';');
	...
	//‹berpr¸ft ob irgendwo ein Signal beendet werden muss.
...
void initBluetoothChip() {
	//Dieser komplette Block ist im Moment noch notwendig um eine serielle Verbindung zum Chip aufbauen zu k√∂nnen.
